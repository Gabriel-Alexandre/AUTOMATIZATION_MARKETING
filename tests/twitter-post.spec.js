...
test('Post a tweet generated by Claude 3.5', async ({ page, context }) => {
  ...
  const tweetText = await generateTweetText();
    ...
    await page.screenshot({ path: 'login-page.png' }).catch(e => console.error('Erro ao capturar screenshot:', e.message));
    ...
    await page.screenshot({ path: 'after-email-input.png' }).catch(() => {});
    ...
    await page.waitForTimeout(5000);
    await page.screenshot({ path: 'after-next-button.png' }).catch(() => {});
    ...
    if (isUnusualActivityScreen) {
      ...
      await page.waitForTimeout(5000);
      await page.screenshot({ path: 'after-unusual-activity.png' }).catch(() => {});
    } else {
    ...
    if (usernameScreen) {
      ...
      // Aguarda para a próxima tela
      await page.waitForTimeout(5000);
      await page.screenshot({ path: 'after-username-screen.png' }).catch(() => {});
    }
  ...
  await page.waitForTimeout(3000);
    ...
    await page.screenshot({ path: 'before-password.png' }).catch(() => {});
    ...
    await page.screenshot({ path: 'before-login-button-click.png' }).catch(e => console.log('Erro ao capturar screenshot:', e.message));
    ...
    // Captura screenshot antes de prosseguir
    await page.screenshot({ path: 'home-page.png' }).catch(e => console.log('Erro ao capturar screenshot:', e.message));
    ...
    try {
      ...
      await page.screenshot({ path: 'post-button-error.png' });
    ...
    await page.screenshot({ path: 'tweet-posted.png' }).catch(e => console.error('Erro ao capturar screenshot final:', e.message));
